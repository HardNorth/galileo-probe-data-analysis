...
44. Rename columns in `output/nfr_mctcnfdn.csv` file with `sed`: `A_MCTCNFDN (W/m^2),B_MCTCNFDN (W/m^2),C_MCTCNFDN (W/m^2),D_MCTCNFDN (W/m^2),E_MCTCNFDN (W/m^2),F_MCTCNFDN (W/m^2)` -> `A (W/m^2),B (W/m^2),C (W/m^2),D (W/m^2),E (W/m^2),F (W/m^2)`
